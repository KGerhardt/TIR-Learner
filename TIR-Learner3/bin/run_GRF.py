...
# LaTeX formula: $$\left\lfloor\sqrt{\frac{\text{num_threads}}{16}} + 1\right\rfloor \times
...
def cpu_cores_allocation_GRF_py_para(cpu_cores, para_mode, num_seq):
    if para_mode == "pystrict":
        ...
        num_threads = int(cpu_cores * process_core_ratio)
        ...
        num_process = cpu_cores * process_core_ratio
