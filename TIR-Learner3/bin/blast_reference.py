...
def blast_ref_lib_in_genome_file(genome_db, genome_name, ref_lib, ref_lib_file_path, processors):
...
def blast_de_novo_result_in_ref_lib(file_name, ref_lib, ref_lib_file_path, processors):
    out = file_name + SPLITER + "blast" + SPLITER + ref_lib
