...
def get_fasta_pieces_single_seqid_SeqIO_tirvish(df_in: pd.DataFrame, genome_SeqRecord: SeqIO.SeqRecord, seqid: str,
...
def get_fasta_pieces_SeqIO_tirvish(genome_file: str, df_in: pd.DataFrame,
    ...
    with mp.Pool(processors) as pool:
        df_with_seq_list = pool.starmap(get_fasta_pieces_single_seqid_SeqIO_tirvish, mp_args_list)
